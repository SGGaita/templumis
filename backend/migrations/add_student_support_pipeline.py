"""
Migration: Add Student Support Pipeline Tables
...
def run_migration():
    conn = psycopg2.connect(
        ...
        database=os.getenv("POSTGRES_DB", "templumis"),
        user=os.getenv("POSTGRES_USER", "templumis"),
        password=os.getenv("POSTGRES_PASSWORD", "Waxmangme86")
    )
    conn.set_isolation_level(ISOLATION_LEVEL_AUTOCOMMIT)
    cursor = conn.cursor()

    print("Starting Student Support Pipeline migration...")
    ...
    """)
    print("✓ Created student_journey_milestones table")
    ...
    """)
    print("✓ Created student_advisors table")
    ...
    """)
    print("✓ Created library_resources table")
    ...
    """)
    print("✓ Created support_resource_links table")
    ...
    """)
    print("✓ Created student_risk_scores table")
    ...
    """)
    print("✓ Created postgrad_support table")

    # 7. Add columns to support_tickets table
    cursor.execute("""
        DO $$ 
        BEGIN
        ...
        END $$;
    """)
    print("✓ Added columns to support_tickets table")
    ...
    cursor.execute("""
        ...
        END $$;
    """)
    print("✓ Added columns to students table")
    ...
    cursor.execute("""
        ...
        END $$;
    """)
    print("✓ Enhanced student_interventions table")
    ...
    print("\n✅ Student Support Pipeline migration completed successfully!")
